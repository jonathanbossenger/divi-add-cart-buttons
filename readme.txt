...
Installing "Divi Add Cart" can be done either by searching for "Divi Add Cart" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
